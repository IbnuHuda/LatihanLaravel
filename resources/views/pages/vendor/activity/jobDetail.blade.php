            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4 text-center">
                        ...
                        <img src="{{ url('storage/images/company/'. $data_company->company_logo) }}" class="w-100 mt-4">
                    </div>
                    ...
                    <div class="col-md-8">
                        <table border="0" class="table table-striped"  style="font-size: 15px; color:black">
                            <tbody>
                                <tr>
                                    <td>Publisher</td>
                                    <td>:</td>
                                    <td>{{ $data_company->userCompany->name }}</td>
                                </tr>
                                <tr>
                                    <td>Available Positions</td>
                                    <td>:</td>
                        ...
                        <div class="float-right mt-2">
                            <button onclick="window.history.back();" class="btn btn-md btn-danger"><i class="fa fa-arrow-left"></i> Back</button> 
                            <a href="{{ route('usersRegisterJobs', $detail_jobs->id) }}" class="btn btn-primary">Enroll</a>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="{{ route('myCompanyJobs')}}  " class="btn btn-sm btn-primary float-right mt-4">See More Jobs</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><a href="{{ route('usersProfile') }}" class="btn btn-sm btn-primary float-right">Read More</a></li>
                        </ul>
                    </div>
                </div>
            </div>

    ...
    <div class="col-md-12">
        <div class="card bg-light">
            <form action="{{ route('companyPublishJobs') }}" method="post">
                @csrf
                <div class="card-body">
                    <h4 class="card-title float-left">Publish New Jobs</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-label-group">
                                    ...
                                    <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Company Name" value="{{ $data->name }}" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-label-group">
                                    ...
                                    <input type="text" id="positions" name="available_positions" class="form-control" placeholder="Available Positions" required />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-label-group mt-3">
                                    ...
                                    <textarea class="form-control" id="jobs_description" name="jobs_description" placeholder="Jobs Description" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-label-group mt-3">
                                    ...
                                    <textarea class="form-control" id="requirements" name="jobs_requirements" placeholder="Requirements Jobs" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-label-group mt-3">
                                    ...
                                    <input type="number" id="portofolio" name="minimum_portofolio" class="form-control" placeholder="Minimum Portofolio">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-label-group mt-3">
                                    ...
                                    <input type="number" id="vendor_accepted_total" name="vendor_accepted_total" class="form-control" placeholder="Vendor Accepted Total" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-label-group mt-3">
                                    ...
                                    <input type="date" id="jobs_expired" name="jobs_expired" class="form-control" placeholder="Jobs Expired" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-label-group mt-3">
                                    ...
                                    <textarea type="text" id="jobs_expired" name="other" class="form-control" placeholder="Other" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-label-group mt-5">
                                    <div class="row">
                                        ...
                                        <span class="col-8"><button type="submit" class="btn btn-success w-100">Publish Jobs</button></span>
                                    </div>
                                </div>
                            </div>

...
//         if ($data != null) {
//             $detail_jobs = CompanyJobs::where('id', '=', $id)->first();
//             $data_company = CompanyProfile::where('user_company_id', '=', $detail_jobs->user_company_id)->first();

//             return view('pages.vendor.activity.jobDetail', compact('data_company', 'detail_jobs'));
//         }
